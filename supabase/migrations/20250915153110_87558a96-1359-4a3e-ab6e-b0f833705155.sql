-- Security Fix: Strengthen RLS policies and add additional security measures
...
WITH CHECK (recipient_id = auth.uid() AND sender_id = OLD.sender_id);
...
-- 9. Add data validation triggers for sensitive fields
